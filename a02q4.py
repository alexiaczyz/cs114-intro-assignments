...
def trajectory(xv:float, yv:float, xa:float, ya:float, tx:float, tw:float, ty:float, th:float,delta:float, cb:typing.Callable)->bool:
    ...
    target is tw units wide and th units tall
    delta is the timestep measured in seconds to take 
    cb is a callback function to help communicate the rockets trajectory
